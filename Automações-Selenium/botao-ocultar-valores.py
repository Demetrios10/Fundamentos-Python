...
# clicando no Botão Ocultar valores
botao_ocultar_valores = driver.find_element(By.CLASS_NAME,"om-header-options-text")
botao_ocultar_valores.click()
time.sleep(10)
